...
{
    public class StudentGradeSummaryModel : BasePageModel
    {
        ...
        public StudentGradeSummaryModel(ApplicationDbContext context, UserManager<HomeSchoolDayBookUser> userManager)
        {
            _context = context;
